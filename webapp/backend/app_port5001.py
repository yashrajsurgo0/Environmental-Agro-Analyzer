#!/usr/bin/env python
"""
Agricultural Data Analysis Backend - Modified for demo
"""
import os
import json
...
if __name__ == '__main__':
    ...
    # Load the real data and analyze it automatically
    try:
        print("📁 Loading real Maharashtra data...")
        df = pd.read_csv('/Users/yashrajsurgoniwar/Desktop/PROJECT/maharashtra_agricultural_data.csv')
        ...
        print("✅ Pre-loaded analysis complete!")
        print(f"\nModel Performance:")
        print(f"  Linear Regression R²: {models['models']['linear_regression']['r2_score']:.3f}")
        print(f"  Random Forest R²: {models['models']['random_forest']['r2_score']:.3f}")
    except Exception as e:
